VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} f__Calculadora 
   Caption         =   ":: Calculadora ::"
   ClientHeight    =   2865
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   2790
   OleObjectBlob   =   "f__Calculadora.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "f__Calculadora"
...
Dim oCalculadora    As New c__Calculadora
